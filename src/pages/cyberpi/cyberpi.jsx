        ...
        >
          <Box w="1160px" m="0 auto">
            <Box
              ...
              paddingTop="140px"
            >
              <Box fontSize="62px" paddingBottom="20px" fontWeight="bold">
                天空一号
              </Box>
              <Box fontSize="24px" paddingBottom="10px" lineHeight="30px">
                用于计算机科学和AI教育的可联网微控制器
              </Box>
              <Box color="#9fa5af" fontSize="16px">
                “童芯派“专为 AIoT 与 Python 教学而设计，配套慧编程软件，
                可实践入门到精通的 AIoT 应用教学，并把好玩有趣的
                Python编程带入课堂。无论是创新科技应用还是编程普及，童芯派都能完美适配”趣“教学。
              </Box>
            </Box>
          </Box>
        </Box>
          ...
          <Box w="1060px" m="0 auto">
            ...
            <Box textAlign="center" paddingTop="30px">
              ...
              <Box
                ...
                fontWeight="bold"
              >
                硬件和软件的结合使Python学习引人入胜
              </Box>
              <Box fontSize="22px" padding="20px 0" color="#fff">
                全新的mBlock
                Python编辑器是一个旨在学习和教授Python和Micropython的平台，它将AI和数据科学的学习推向了下一个台阶。
              </Box>
              ...
              <Box
                ...
                fontWeight="bold"
              >
                以全新的方式增强Python的教学和创建能力
              </Box>
              <Box fontSize="16px" padding="20px 0 50px" color="#fff">
                只需一个按钮即可安装编辑器| 使用按钮下载第三方python库|
                丰富的硬件和软件示例程序
              </Box>
              <Box textAlign="center" color="#fff" paddingBottom="140px">
                <Box display="inline-block" width="274px" verticalAlign="top">
                  ...
                  <Box fontSize="22px" paddingTop="20px">
                    访问Python编辑器
                  </Box>
          ...
          <Box textAlign="center" paddingTop="180px">
            ...
            <Box color="#171e49" paddingBottom="140px">
              <Box display="inline-block" width="274px" verticalAlign="top">
                ...
                <Box textAlign="left" fontSize="22px" paddingTop="20px">
                  将数据科学引入课堂并可视化学习成果
                </Box>
                <Box textAlign="left">
                  1.44英寸高清全彩屏幕，用于以多种颜色显示不同的数据，使数据收集，处理和统计信息完全可视化。
                </Box>
              </Box>
              <Box display="inline-block" width="274px" margin="0 20px">
                ...
                <Box textAlign="left">
                  CyberPi具有内置麦克风和高品质扬声器，可与mBlock的认知服务配合使用，使语音识别和文本阅读更加轻松，从而帮助学生探索先进技术。
                </Box>
              </Box>
              <Box display="inline-block" width="274px" verticalAlign="top">
                ...
                <Box textAlign="left">
                  凭借其内置的Wi-Fi模块和mBlock的云广播功能，CyberPi可用于创建IoT项目，例如DIY智能家电。
                </Box>
              </Box>
            </Box>
            ...
            <Box textAlign="center" paddingBottom="50px">
              ...
              >
                <Box float="right" width="430px" textAlign="left" color="#fff">
                  ...
                  <Box fontSize="28px" paddingBottom="20px">
                    为CyberPi设计的自行开发的操作系统
                  </Box>
                  <Box>
                    存储多个程序并在程序之间无缝切换 允许重命名设备|
                    Wi-Fi自动加入
                  </Box>
                </Box>
              </Box>
