...
function shree() {
    ...
    return (
        <Box>
            <Text fontWeight="bold" fontSize="24px" m="15px 0" textAlign="center">创客空间</Text>
            ...
            <Text fontWeight="bold" fontSize="24px" m="15px 0" textAlign="center">创客教育套装</Text>
            <Box d="flex">
                <Box w="33.3%" p={4}  >
                    <Box w="100%" p={4} bgColor="#00bbff" borderRadius="10px" textAlign="center">
                        <Image src={banner1} />
                        <Text p={5} fontSize="22px">神经元创意实验室套装</Text>
                        <Link href="https://chakra-ui.com" >
                            <Button colorScheme="teal" variant="outline" p={20, 5} >
                                了解更多
                            </Button>
                ...
                <Box w="33.3%" p={4}  >
                    <Box w="100%" p={4} bgColor="#00bbff" borderRadius="10px" textAlign="center">
                        <Image src={banner1} />
                        <Text p={5} fontSize="22px">科学机器人</Text>
                        <Link href="https://chakra-ui.com" >
                            <Button colorScheme="teal" variant="outline" p={20, 5} >
                                了解更多
                            </Button>
                ...
                <Box w="33.3%" p={4}  >
                    <Box w="100%" p={4} bgColor="#00bbff" borderRadius="10px" textAlign="center">
                        <Image src={banner1} />
                        <Text p={5} fontSize="22px">小创客玩转开源机器人</Text>
                        <Link href="https://chakra-ui.com" >
                            <Button colorScheme="teal" variant="outline" p={20, 5} >
                                了解更多
                            </Button>
