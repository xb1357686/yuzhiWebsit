    ...
    <>
      ...
      >
        ...
        <Flex justifyContent="center" fontSize="24px" color="#fff">
          ...
          <Text>|</Text>
          <Text m="0 10px">机器人教育</Text>
          <Text>|</Text>
          <Text m="0 10px">创客教育</Text>
          <Text>|</Text>
          <Text m="0 10px">科技劳动教育</Text>
          <Text>|</Text>
          <Text m="0 10px">综合实践活动</Text>
          <Text>|</Text>
          <Text m="0 10px">活动运营</Text>
          <Text>|</Text>
          <Text m="0 10px">空间设计</Text>
        </Flex>
        <Box m="75px 0">{/* <Image w="100%" src={banner1} /> */}</Box>
        <Content title="人工智能与编程教育">
          <Text>
            早在2017年，国务院已出台《新一代人工智能发展规划》，要求在中小学阶段设置人工智能相关课程，逐步推广编程教育。人工智能与编程俨然成为21世纪中小学生的关键技能。
          </Text>
          <Text>
            育智科创为学校开展人工智能与编程教育提供完整的软硬件服务与支持，我们将虚拟世界的编程通过现实世界中的硬件产品呈现出来，为学生打开好奇求知的大门，让其体验人工智能与编程的无穷魅力。
          </Text>
          {/* <One /> */}
        </Content>
