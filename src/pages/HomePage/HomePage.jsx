  ...
  return (
    <Box>
      ...
      <Content title="机器人教育" bgUrl={banner5}>
        ...
        <Text>
          育智机器人教育依托机器人赛事，通过国际化的机器人挑战赛、STEAM 嘉年华等活动形式，为学生提供与全球青少年同台竞技的机会，为中小学生综合能力、信息素养的提升提供平台。
        </Text>
        <Two />
      </Content>
      ...
      <Content title="创客教育" bgUrl={banner6}>
        ...
        <Text>
          育智科创的创客教育解决方案，以解决现实生活中的问题为出发点，通过 PBL项目式学习理念，让学生灵活使用各种器材、工具和软件来进行造物，并在此过程中培养学生的自主学习能力、动手能力、协作能力、逻辑思维和创造力。
        </Text>
        <Shree />
      </Content>
      ...
      <Content title="科技劳动教育" bgUrl={gb} >
        <Text >
          2020年，国务院已出台《中共中央 国务院关于全面加强新时代大中小学劳动教育的意见》，要求把劳动教育纳入人才培养全过程，整体优化学校课程设置，将劳动教育纳入中小学国家课程方案，形成具有综合性、实践性、开放性、针对性的劳动教育课程体系。
        </Text>
        <Text>
      ...
      <Content title="活动运营" bgUrl={gb} >
        <Text >
          ...
          一系列活动，不但帮助学校提升创新创造的氛围，还能形成教学品牌效 </Text>
        <Sex />
      </Content>
