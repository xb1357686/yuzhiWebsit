...
function Introduce() {
    ...
    return (
        <Box padding="80px">
            ...
            <Box fontSize="36px" fontWeight="400" lineHeight="61px" color="#333333" textAlign="center" position="relative">课程服务</Box>
            ...
            <Box d="flex">
                ...
                <Box w="50%" p={2} >
                    <Box w="90%">
                        ...
                        <Box fontSize="16px" lineHeight="25px" color="#666666">前海学校是一所集小学、初中于一体的九年一贯制、现代化、特色公立学 校。学校占地面积37412平方米，建筑面积20963平方米，位于南山区前海湾之滨，临海听风，置身高尚社区，自然与人文环境优越，是一方理想的读书圣地。
                        </Box>
