...
function Introduce() {
  return (
    <Box padding="0 80px 80px" textAlign="center" w="1160px" m="100px auto">
      <Box
        fontSize="36px"
        fontWeight="400"
        lineHeight="61px"
      ...
      <Box d="flex" flexDirection="row" alignItems="top">
        <Box width="16.6%">
          ...
          <Box padding="10px" fontSize="16px" color="#00a7e2">
            创新思维
          </Box>
          <Box padding="0 20px" fontSize="12px">
            基于STEAM教育的思维训练教程
          </Box>
        </Box>
        <Box width="16.6%">
          <Image src={Curriculum3} display="inline-block" />
          <Box padding="10px" fontSize="16px" color="#fdac0e">
            编程教育
          </Box>
          <Box padding="0 20px" fontSize="12px">
            基于STEAM深度开发的Labplus软件开发互动编程课程
          </Box>
        </Box>
        <Box width="16.6%">
          <Image src={Curriculum4} display="inline-block" />
          <Box padding="10px" fontSize="16px" color="#2da05a">
            智能电子
          </Box>
          <Box padding="0 20px" fontSize="12px">
            基于智能电子硬件深度开发的产品及课程
        ...
        <Box width="16.6%">
          ...
          <Box padding="10px" fontSize="16px" color="#ef750e">
            结构设计
          </Box>
          <Box padding="0 20px" fontSize="12px">
            基于草图大师建模软件的3D建模课程
        ...
        <Box width="16.6%">
          ...
          <Box padding="0 20px" fontSize="12px">
            基于激光切割机，3D打印机，微型机床工具的课程
          </Box>
        </Box>
        <Box width="16.6%">
          <Image src={Curriculum8} display="inline-block" />
          <Box padding="10px" fontSize="16px" color="#bc2787">
            分享
          </Box>
          <Box padding="0 20px" fontSize="12px">
            基于创意和作品的演讲分享交流课程
      ...
      <Box padding="10px 200px 30px" textAlign="center" color="#aaaaaa">
        盛思联合国内创客教育专家与名师编辑了软件编程、智能电子、3D打印、物联网、人工智能、机器人等一系列STEAM创客教育课程，经多地名校实践和完善，现已有20余本教材出版发行。
      </Box>
