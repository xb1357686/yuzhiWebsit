...
function Introduce() {
    ...
    return (
        <Box padding="40px 80px 60px" bg="#F8F8F8">
            <Box textAlign="center" paddingBottom="30px">
                <Box width="8px" height="8px" borderRadius="10px" bg="#E61E32" display="inline-block"></Box>
                <Box fontSize="20px" color="#333" display="inline-block" marginLeft="5px" verticalAlign="middle">案例教学过程</Box>
            </Box>
            <Box d="flex">
                <Box w="25%" p={6}  >
